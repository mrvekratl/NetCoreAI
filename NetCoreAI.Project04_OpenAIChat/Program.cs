...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        Console.WriteLine("Lütfen sorunuzu yazınız: (örnek: 'Merhaba bugün hava Ankara'da kaç derece?')");
        ...
        try
        {
            var response = await httpClient.PostAsync("https://api.openai./v1/chat/completions",content);
